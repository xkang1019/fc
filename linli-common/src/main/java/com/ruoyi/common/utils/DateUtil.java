...
//下面的就是把当前日期加一个月
     ...
     * @return
     */
    public static float getDays(String date1, String date2) {
        ...
        float day = (float) ((date.getTime() - mydate.getTime()) / (24 * 60 * 60 * 1000 * 1.0));
     ...
     * @return
     */
    public  static  boolean getDayBetweenTwoDate(Date date1now,Date date2){
        return date1now.getTime() > date2.getTime();
    }
