...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/weixinpay/GetOpenId**","anon");
        filterChainDefinitionMap.put("/weixinpay/getOpenIdWeb**","anon");
        filterChainDefinitionMap.put("/weixinpay/wechatParam**","anon");
        ...
        filterChainDefinitionMap.put("/kanjia/kanjiaUser/web/**","anon");
